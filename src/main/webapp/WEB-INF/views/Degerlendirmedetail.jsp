...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-address-book"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="first" type="text" placeholder="Staj Puanı" disabled="disabled" id="staj_puanı">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="email" type="text" placeholder="İse Devam Süresi" disabled="disabled" id="ise_devam">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="phone" type="text" placeholder="Staj Yorumu" disabled="disabled" id="staj_yorumu">
    </div>
</div>
...
<div class="w3-row w3-section">
<div class="w3-rest">
<button class="w3-button w3-block w3-section w3-green w3-ripple w3-padding"  id="updateBtn"onclick="update()">Guncelle Degerlendirme</button>
<button class="w3-button w3-block w3-section w3-red w3-ripple w3-padding" onclick="deleteDegerlendirme()">Sil Degerlendirme</button>
</div>
	...
	<script src="./../asset/custom/Degerlendirmedetail.js"></script>
